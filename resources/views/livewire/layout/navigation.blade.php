...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        @guest
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('login')" :active="request()->routeIs('vacantes.index')" wire:navigate>
                    {{ __('Login') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('register')" :active="request()->routeIs('vacantes.create')" wire:navigate>
                    {{ __('Register') }}
                </x-responsive-nav-link>
            </div>
        @endguest
        @auth
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('notificaciones')" wire:navigate class="flex items-center">
                        @if (auth()->user()->unreadNotifications->count())
