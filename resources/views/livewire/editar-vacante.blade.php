<form class="max-w-xl mx-auto space-y-4" wire:submit.prevent='editarVacante'>
...
<div>
        <x-input-label for="imagen" />
        <x-text-input wire:model="imagen_nueva" id="imagen_nueva" type="file" placeholder="imagen vacante" accept="image/*" />
        <div>
            @if ($imagen_nueva)
